...
const App = () => {
  ...
  return (
    ...
    {/* Centered Box */}
    <div className="w-full max-w-md bg-gray-900 p-8 rounded-xl shadow-2xl border-2 border-gray-800 text-center mx-auto">
      {/* Title */}
      ...
      {showNameInput && (
        <>
          <input
            ...
            className="border p-3 rounded-lg w-full mb-4 bg-gray-800 text-white border-gray-700 focus:ring-2 focus:ring-blue-500 transition"
          />
      ...
      {gameStarted && (
        <>
          <input
            ...
            className="border p-3 rounded-lg w-full mb-4 bg-gray-800 text-white border-gray-700 focus:ring-2 focus:ring-green-500 transition"
          />
          <button
            onClick={checkGuess}
